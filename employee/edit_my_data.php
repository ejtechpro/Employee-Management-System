...
<section class="addemp">
  <form action="edit_emp.php?id=<?=$uid?>" Method="POST" autocomplete="off">
    <fieldset>
      ...
      <div class="formfields">
        ...
        <div class="field">
          <label>Email</label>
          <input type="email" name="email" required value="<?= isset($emp_email) ? $emp_email : '' ?>" disabled>
        </div>
        <div class="field">
    ...
    <fieldset>
      ...
      <div class="formfields">
        <div class="field">
          ...
          <select name="dep_name" required disabled>
        ...
        <div class="field">
          <label>Job</label>
          <input type="text" name="job" required value="<?= isset($job) ? $job : '' ?>" disabled>
        </div>
        <div class="field">
          <label>Daily Rate</label>
          <input type="number" name="dailyrate" min="0" required value="<?= isset($emp_daily_rate) ? $emp_daily_rate : '' ?>" disabled>
        </div>
        <div class="field">
        ...
        <div class="field">
          <label>Status</label>
          <select name="workingstatus" required disabled>
        ...
        <div class="field">
          ...
          isset($emp_hired_date) ? $emp_hired_date : '' ?>" disabled>
        </div>
